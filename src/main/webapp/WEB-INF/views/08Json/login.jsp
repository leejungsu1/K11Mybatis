...
$(function(){
	...
	$('#loginBtn').click(function(){
		...
		$.ajax({
			...
			type : "post",				//전송방식
			contentType : "application/x-www-form-urlencoded;charset:utf-8;",	//컨텐츠타입
			data : {					//서버로 전송할 파라미터(JSON타입)
				id : $('#id').val(),
				pass : $('#pass').val()
			},
			dateType : "json",			//콜백데이터의 타입
				...
				<table class="table-bordered" style="width:50%;">
					<tr>
						<td>
							<input type="text" class="form-control" name="id" 
									id="id"  placeholder="아이디" tabindex="1">
						</td>
					...
					<tr>
						...
						<input type="password" class="form-control" name="pass"  
								id="pass" placeholder="패스워드" tabindex="2">
						</td>
					</tr>
				</table>
			</form>
